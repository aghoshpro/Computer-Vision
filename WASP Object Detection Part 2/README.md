...
[CoCo Data Set](https://cocodataset.org/#home): 

### Dataset
[Coco Names](https://github.com/nightrome/cocostuff/blob/master/labels.md): 182 names of objects (labels) that can be detected on the video
